...
tabs.forEach(tab => {
    tab.addEventListener('click',  function(e){
        ...
        const color = tab.style.getPropertyValue('--color');
...
function Timeline(cvs) {
    ...
    self.dotColors = [
/*         ['rgba(0, 0, 0, 1)', 'rgba(19, 102, 155, 0.3)', 'rgba(0, 0, 0, 0.5)'] */
        ['white', 'black'],
/*         ['black', 'rgba(113, 222, 15, 0.6)', 'rgba(91, 164, 22, 0.5)'], */
        ['white', 'black'],
    ];
    ...
    function OnResize() {
        ...
        self.toggle(false);
        // Init lines
        self.lines[0].reset(canvas.offsetWidth / 2 - 35);
        self.lines[1].reset(canvas.offsetWidth / 2 + 35);
    ...
    function init() {
        ...
        try {
            ...
            self.lines[0] = new Line(250, canvas.offsetHeight - 100, '#56727A', self.options, mouse);
            self.lines[1] = new Line(250, canvas.offsetHeight - 100, '#323232', self.options, mouse);
    ...
    function redraw() {
        ...
        for (var i = 0; i < 2; i++) {
            ...
            for (var j = 0; j < self.lines[i].dots.length; j++) {
                ...
                drawLine(p1, p2);
                drawCircle(p1, 5, self.dotColors[i][0]);
                drawCircle(p2, 5, self.dotColors[i][1]);
                drawCircle(p2, 13, self.dotColors[i][1]);
                drawCircle(p2, 10, self.dotColors[i][0]);
            }
        }
    }
